      ...
      switch (sortBy) {
        ...
        case "units": {
          const aUnits =
            a.unitsTotal === 0
              ? 0
              : (a.unitsOccupied / a.unitsTotal) * 100;
          const bUnits =
            b.unitsTotal === 0
              ? 0
              : (b.unitsOccupied / b.unitsTotal) * 100;
          aVal = aUnits;
          bVal = bUnits;
          break;
        }
            ...
            <thead className="border-b bg-slate-50 text-xs font-medium text-slate-500">
              <tr>
                ...
                <th className="px-4 py-2">
                  ...
                  >
                    Location
                    <span className="text-[10px]">{sortIcon("city")}</span>
                  </button>
                </th>
                <th className="px-4 py-2">
                  <button
                  ...
                  >
                    Type
                    <span className="text-[10px]">{sortIcon("type")}</span>
                  </button>
                </th>
                <th className="px-4 py-2">
                  <button
                  ...
                  >
                    Units
                    <span className="text-[10px]">{sortIcon("units")}</span>
                  </button>
                </th>
                <th className="px-4 py-2">
                  <button
                  ...
                  >
                    Vacant
                    <span className="text-[10px]">{sortIcon("vacant")}</span>
                  </button>
                </th>
                <th className="px-4 py-2">
                  <button
                  ...
                  >
                    Status
                    <span className="text-[10px]">{sortIcon("status")}</span>
                  </button>
                </th>
